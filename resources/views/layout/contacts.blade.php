        ...
        <div class="container contacts flex">
            <div class="left">
                <div class="heading">
                    ...
                    <p class="mt-6 text-md text-white-600">If you have any inquiries, questions, or simply want to say
                        hello, feel free to contact me through one of my socials below or the contact form</p>
                </div>
                {{-- Social --}}
            ...
            <div class="right">
                <div class="form-container">
                    <form action="{{ route('contact-form') }}" method="POST">
                        @csrf
                        <div class="sm:flex md:flex-row gap-4">
                            {{-- First Name Label --}}
